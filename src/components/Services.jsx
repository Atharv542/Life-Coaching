...
const Services = () => {
  ...
  return (
    <section className="mx-auto px-4 sm:px-6 lg:px-12 py-12">
      <h1 className="text-3xl sm:text-5xl font-bold text-center text-[#105153] mb-12 animate-fade-in">
      Transformation Hub
      </h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
        ...
        <div className="bg-white rounded-xl shadow-md overflow-hidden transition-transform transform hover:scale-105">
          ...
          <div className="p-4 sm:p-6">
            <h3 className="text-xl sm:text-[28px] font-semibold mb-2 text-[#105153]">Personal Development</h3>
        ...
        <div className="bg-white rounded-xl shadow-md overflow-hidden transition-transform transform hover:scale-105">
          ...
          <div className="p-4 sm:p-6">
            <h3 className="text-xl sm:text-[28px] font-semibold mb-2 text-[#105153]">Career & Executive Presence</h3>
            <p className="text-gray-600 text-lg sm:text-base mb-4">
        ...
        <div className="bg-white rounded-xl shadow-md overflow-hidden transition-transform transform hover:scale-105">
          ...
          <div className="p-4 sm:p-6">
            <h3 className="text-xl sm:text-[28px] font-semibold mb-2 text-[#105153]">Mindfulness and Spiritual</h3>
            <p className="text-gray-600 text-lg sm:text-base mb-4">
